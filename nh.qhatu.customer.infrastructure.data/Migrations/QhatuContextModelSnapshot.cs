...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("nh.qhatu.customer.domain.core.entities.Address", b =>
                {
            ...
            modelBuilder.Entity("nh.qhatu.customer.domain.core.entities.Customer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("nh.qhatu.customer.domain.core.entities.PaymentMethod", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("nh.qhatu.customer.domain.core.entities.Address", b =>
                {
                    b.HasOne("nh.qhatu.customer.domain.core.entities.Customer", "Customer")
                        .WithMany("Addresses")
